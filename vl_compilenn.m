...
cc = mex.getCompilerConfigurations('c++');
cl_path = 'C:\Program Files (x86)\Microsoft Visual Studio\2019\Community\VC\Tools\MSVC\14.28.29910\bin\Hostx64\x64';
...
for v = {'5.5', '6.0', '6.5', '7.0', '7.5', '8.0', '8.5', '9.0', '9.5', '10.0','11.3'}
  switch computer('arch')
    ...
    case 'win64'
      paths{end+1} = sprintf('C:\Program Files\NVIDIA GPU Computing Toolkit\CUDA\v11.3\binC:\nvcc.exe', char(v)) ;
  end
end
